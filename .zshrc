...
# zsh-completions: make its functions visible to the completion system
autoload -U compinit && compinit

source $ZSH/oh-my-zsh.sh

# --- Tab completion behavior ---
# First TAB completes; repeated TABs cycle through a highlighted menu.
zstyle ':completion:*' menu select
# Case-insensitive matching (e.g. "doc<TAB>" matches "Documents").
zstyle ':completion:*' matcher-list 'm:{a-zA-Z}={A-Za-z}'
# Accept an autosuggestion with the Right arrow, or with Ctrl+Space.
